...
%1.
\filldraw (0,\textwidth/2) circle (2pt) node[align=center, right] {Initial Obligation};
...
%2.
\filldraw (\textwidth/6,\textwidth/3) circle (2pt) node[align=center,   right=3mm] {1. Obligation: \\ generated by Initial};
...
%3.
\filldraw (\textwidth/3,\textwidth/6) circle (2pt) node[align=left,   left=3mm] {2. Obligation: \\ generated by 1.};
...
%4.
\filldraw (\textwidth/2,0) circle (2pt) node[align=center,   below] {Newest Obligation: \\ Generated by 2.};
...
%3.'
\filldraw (\textwidth - \textwidth/3,\textwidth/6) circle (2pt) node[align=right,   right=3mm] {2. Obligation: \\ Blocked};
...
%2.'
\filldraw (\textwidth - \textwidth/6,\textwidth/3) circle (2pt) node[align=center, right=3mm] {1. Obligation: \\ Blocked};
...
%1.'
\filldraw (\textwidth,\textwidth/2) circle (2pt) node[align=center,   left=3mm] {Initial Obligation: \\ Blocked};
...
\draw [decorate] (0, -12mm) -- node[below=3mm, align=center]{This chain of obligations \\ is always the same \\ on each new level}(\textwidth/2 - 2mm, -12mm);
...
\subsection{Interpolation}
Ultimate already supports ways of computing an interpolant for two given formulas. The idea is, that everytime a query to the SMT-solver is unsatisfiable we instead of adding the proof-obligation to the frames, we calculate an interpolant for the query and add that. \par
...
Frames would consist only of interpolants, blocking a bigger state space.
