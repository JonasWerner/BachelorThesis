...
There are however three other approaches:
...
\item $I$ consists only of variables found in $A \cup B$
\end{itemize}
...
\begin{figure}[H]
\centering
\resizebox{0.9\textwidth}{!}{\input{fig/fig_obligations}}
