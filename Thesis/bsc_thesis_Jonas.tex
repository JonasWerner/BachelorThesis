...
\chapter{Evaluation}
In this section we show the efficiency of the implemented algorithm and compare it to Ultimate's Nested Interpolants. \\
Our benchmarks were run on an AMD EPYC 7351P 16-Core Processor with 2.40 GHz using a timeout of 300 seconds, a memory limit of 8 GB, using 2 cores.
...
xtick={0, 5, ..., 170},
ytick={0, 5, ..., 170},
xlabel={CPU Time PDR SMTinterpol},
ylabel={CPU Time Nested Interpolants},
xmin=0,
xmax=50,
ymin=0,
ymax=50,
...
\begin{minipage}[t]{0.5\textwidth}
	...
	%xtick={0,10000000 , ..., 350000000},
	%ytick={0, 10000000, ..., 350000000},
	xlabel={Memory Usage PDR SMTinterpol},
	ylabel={Memory Usage Nested Interpolants},
	xmin=0,
	xmax=350000000,
	ymin=0,
	ymax=350000000,
